...
# You need to change it to a relevant folder on your computer containing the MNIST data

DATA_FOLDER_PATH <- '/Cloud/Box Sync/Repos/DATA/DATA___LeCun___MNISTDigits'

# *************************************************************************************

data <- load_mnist(DATA_FOLDER_PATH)
